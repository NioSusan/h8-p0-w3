...
var name="Susan"; // nama harus diisi
var age=18; // umur harus diatas 17 tahun baru bisa masuk
var money=20000; // harus di atas 50000
...
if(name===""){
  ...
  console.log(`Anda bisa masuk kasino. Uang anda saat ini ${money-50000}`);
} else {
